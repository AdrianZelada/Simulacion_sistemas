...
var sum2001=0,sum2002=0,sum2003=0,sum2004=0,sum2005=0,sum2006=0,sum2007=0,sum2008=0,sum2009=0sum2010=0,sum2011=0,sum2012=0,sum2013=0,sum2014=0
	...
	for(item in datos){			
		...
		/*var sumMes=parseInt(datos[item]["2001 "])+parseInt(datos[item]["2002 "])+parseInt(datos[item]["2003 "])+parseInt(datos[item]["2004 "])+parseInt(datos[item]["2005 "])+parseInt(datos[item]["2006 "])+parseInt(datos[item]["2007 "])+parseInt(datos[item]["2008 "])+parseInt(datos[item]["2009 "])+parseInt(datos[item]["2010 "])+parseInt(datos[item]["2011 "])+parseInt(datos[item]["2012 "])+parseInt(datos[item]["2013 "])+parseInt(datos[item]["2014 "]);
		content.innerHTML=content.innerHTML+block(sumMes);		
		content.innerHTML=content.innerHTML+'</br> </br>';
sum2001=sum2001+parseInt(datos[item]["2010 "]);
sum2002=sum2002+parseInt(datos[item]["2010 "]);
sum2003=sum2003+parseInt(datos[item]["2010 "]);
sum2004=sum2004+parseInt(datos[item]["2010 "]);
sum2005=sum2005+parseInt(datos[item]["2010 "]);
sum2006=sum2006+parseInt(datos[item]["2010 "]);
sum2007=sum2007+parseInt(datos[item]["2010 "]);
sum2008=sum2008+parseInt(datos[item]["2010 "]);
sum2009=sum2009+parseInt(datos[item]["2010 "]);
sum2010=sum2010+parseInt(datos[item]["2010 "]);
	...
	/*content.innerHTML=content.innerHTML+block("Totales");	
		content.innerHTML=content.innerHTML+block(sum2001);	
	content.innerHTML=content.innerHTML+block(sum2002);	
	content.innerHTML=content.innerHTML+block(sum2003);	
		content.innerHTML=content.innerHTML+block(sum2004);	
			content.innerHTML=content.innerHTML+block(sum2005);	
		content.innerHTML=content.innerHTML+block(sum2006);	
	content.innerHTML=content.innerHTML+block(sum2007);	
		content.innerHTML=content.innerHTML+block(sum2008);	
			content.innerHTML=content.innerHTML+block(sum2009);	
	...
	content.innerHTML=content.innerHTML+block(sum2001+sum2002+sum2003+sum2004+sum2005+sum2006+sum2007+sum2008+sum2009+sum2014+sum2013+sum2012+sum2011+sum2010);*/
